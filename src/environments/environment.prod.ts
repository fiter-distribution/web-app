...
export const environment = {
  ...
  fineractPlatformTenantId: window['env']['fineractPlatformTenantId'] || 'FinanceHouse',
  fineractPlatformTenantIds: window['env']['fineractPlatformTenantIds'] || 'FinanceHouse,Providus',
